<?php
    ...
    if ($err) {
        $erro = true;
        $mensagem_erro = 'Erro obten��o dos pedidos: '.$httpcode . ' - ' . $err;
    } else {
        if (
            $httpcode != 200
            && $httpcode != 201
            ...
            $erro = true;
            $mensagem_erro = 'Erro obten��o dos pedidos HTTP: ' . $httpcode;
        }
    }
...
<head>
    ...
    <title>Prot�tipo tela Gest�o de Pedidos</title>
            ...
            <div class="detalhes-pedido box-border rounded column col-12">
                <div class="titulo-pagina ctn-detalhes d-flex gap-2 gap-xl-3 p-2 d-flex flex-wrap justify-content-between">
                    <div class="col-auto d-flex flex-row gap-1 ">
                        ...
                        <div
                            ...
                            <i class="pedido-action funcao-pedido fad fa-print"
                               title="Imprimir c�pia do pedido"></i>
                        </div>
                    </div>
                    <div
                        ...
                        <a href=""><i class="status-lista fad fa-box-full"
                                      title="Imprimir folha de separa��o"></i></a>
                        <span class="m-0 p-0">/</span>
                    ...
                    <div class="d-flex d-flex gap-2 gap-xl-3 col-auto m-0 justify-content-between">
                        ...
                        <!-- Bot�o para chamar a pr�xima a��o do pedido
                ...
                <div class="modal fade " id="data-entrega" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-prazo">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5">Previs�o de entrega</h1>
                        ...
                        <div class="container form-group form-observacao">
                            <div class="row">
                                <div class="mb-3 col-8 col-lg-10">
                                    <label for="obs-dist">Observa��es do cliente</label>
                                    ...
                                    <div>
                                        <table class="table table-striped tabela-produtos-th">
                                            ...
                                            <tr>
                                                ...
                                                <th class="col-auto d-none d-lg-table-cell">Pre�o</th>
                                            ...
                                            <tr>
                                                <td>MUSSARELA PE�A MISTURA - SAPUTO</td>
                                    ...
                                    <div>
                                        <table class="table table-striped tabela-produtos-th">
                                            ...
                                            <tr>
                                                ...
                                                <th class="col tabela-produto-valor d-none d-lg-table-cell">Pre�o</th>
                                    ...
                                    <div id="listagem_itens_pedidos">
                                        <div>
                                            ...
                                            <table class="table table-striped tabela-produtos-th">
                                                ...
                                                <tbody class="tabela-produtos-edicao">
                                                    <tr>
                                                        <td class="">MUSSARELA PE�A MISTURA - SAPUTO</td>
                                                        <td>20,00</td>
                                                        <td>29,90</td>
                                                        <td>598,00</td>
                                                    </tr>
